...
import com.algashop.ordering.core.domain.product.ProductOutOfStockException;
...
class OrderTest {
    ...
    public void shouldGenerate() {
        ...
        Assertions.assertWith(order,
                ...
                o-> Assertions.assertThat(o.itens()).isEmpty(),
    ...
    public void shouldAddItem() {
        ...
        Assertions.assertThat(order.itens().size()).isEqualTo(1);
    ...
    public void shouldGenerateExceptionWhenTryToChangeItemSet() {
        ...
        Set<OrderItem> items = order.itens();
    ...
    public void givenDraftOrder_whenChangeItem_shouldRecalculate() {
        ...
        Assertions.assertWith(order,
                ...
                (o) -> Assertions.assertThat(o.totalItens()).isEqualTo(new Quantity(5))
        );
    }

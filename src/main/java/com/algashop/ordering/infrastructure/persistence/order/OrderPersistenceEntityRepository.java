...
public interface OrderPersistenceEntityRepository extends JpaRepository<OrderPersistenceEntity, String> {
    @Query("""
        SELECT o
    ...
    @Override
    @EntityGraph(attributePaths = {"customer", "itens"})
    Optional<OrderPersistenceEntity> findById(String id);
}

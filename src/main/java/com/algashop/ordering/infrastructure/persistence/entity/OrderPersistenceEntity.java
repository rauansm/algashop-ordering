...
public class OrderPersistenceEntity {
    ...
    private Set<OrderItemPersistenceEntity> itens = new HashSet<>();

    @Builder
    public OrderPersistenceEntity(String id, CustomerPersistenceEntity customer, BigDecimal totalAmount, Integer totalItems, String status, String paymentMethod, OffsetDateTime placedAt, OffsetDateTime paidAt, OffsetDateTime canceledAt, OffsetDateTime readyAt, UUID createdByUserId, OffsetDateTime lastModifiedAt, UUID lastModifiedByUserId, Long version, BillingEmbeddable billing, ShippingEmbeddable shipping, Set<OrderItemPersistenceEntity> itens) {
        this.id = id;
        ...
        this.replaceItens(itens);
    }

    public void replaceItens(Set<OrderItemPersistenceEntity> items) {

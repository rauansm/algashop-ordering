...
import com.algashop.ordering.domain.repository.Orders;
...
public class OrdersPersistenceProvider implements Orders {
    ...
    public Optional<Order> ofId(OrderId orderId) {
        Optional<OrderPersistenceEntity> possibleEntity = persistenceRepository.findById(orderId.toString());
    ...
    public boolean exists(OrderId orderId) {
        return persistenceRepository.existsById(orderId.toString());
    }

    @Override
    @Transactional(readOnly = false)
    public void add(Order aggregateRoot) {
        String orderId = aggregateRoot.id().value().toString();
    ...
    public long salesQuantityByCustomerInYear(CustomerId customerId, Year year) {
        return persistenceRepository.salesQuantityByCustomerInYear(
                customerId.value(),
                year.getValue());
    }

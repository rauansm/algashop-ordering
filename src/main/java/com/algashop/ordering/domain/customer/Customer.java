...
import com.algashop.ordering.domain.AbstractEventSourceEntity;
import com.algashop.ordering.domain.AggregateRoot;
...
import static com.algashop.ordering.domain.ErrorMessages.VALIDATION_ERROR_FULLNAME_IS_NULL;
...
public class Customer extends AbstractEventSourceEntity implements AggregateRoot<CustomerId> {
    ...
    public static Customer createBrandNew(FullName fullName, BirthDate birthDate, Email email,
